...
//load queue class file
require 'mikrotik/queue/mapi_queue_simple.php';

//load raidius class file
require 'mikrotik/radius/mapi_radius.php';
...
class Mikrotik_Api {
    ...
    /**
     * This metod used call class Mapi_System_Scheduler
     * @return Mapi_Queue_Simple
     */
    public function queue_simple(){
        return new Mapi_Queue_Simple($this->param);
    }

    /**
     * This metod used call class Mapi_System_Scheduler
     * @return Mapi_Radius_Simple
     */
    public function radius(){
        return new Mapi_Radius($this->param);
    }
