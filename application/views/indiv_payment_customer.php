...
if((permission("Cus","ad_ P@_yment",$permission_string)===0) || (permission("Cus","View",$permission_string)===-1)){
echo "<script>
		...
		<div _ngcontent-c6="" class="col-sm-6 col-sm-offset-3">
			<div _ngcontent-c6="" class="card">
                ...
                <a  class="list-group-item list-group-item-action">Invoice Date : <?php echo $invoice_date ?></a>
							...
							<a style="float:right;"onclick="javascript:void(0)"  class="btn btn-info  delete_user col-md-5 " href="<?php echo base_url(); ?>ppp/view_indiv_invoice/<?=$id_net_user?>">Back</a>
						<?php } ?>
						</form>
				...
				<div  class="card card-pricing card-raised">
					<div class="content">
						<div _ngcontent-c6="" class="card-header" data-background-color="blue">
							...
							<?php if( permission("Cus","V_iew I_nvoice",$permission_string)===1 ){ ?>
							<a href="<?php echo base_url(); ?>ppp/view_indiv_invoice/<?=$id_net_user?>" class="btn btn-info btn-round">View Invoice</a>
							<?php } ?>
						</div>
					</div>
				</div>
